...
export default function Page() {
  ...
  // Si existe transportista seleccionado, actualiza
  if (transportistaEditar) {

    const listaActualizada = transportistas.map((t) =>
      t.idTransportista === transportistaEditar.idTransportista
        ? {
            idTransportista: transportistaEditar.idTransportista,
            ...transportista,
          }
        : t
    );
    ...
    setTransportistas(listaActualizada);

    setTransportistaEditar(null);
...
const editarTransportista = (transportista: Transportista) => {
  ...
  const eliminarTransportista = (idTransportista: number) => {
    ...
    if (confirmar) {
      ...
      const nuevaLista = transportistas.filter(
        (t) => t.idTransportista !== idTransportista
      );


      setTransportistas(nuevaLista);

      console.log("Eliminar:", idTransportista);
  ...
  <TransportistaForm
    onGuardar={agregarTransportista}
